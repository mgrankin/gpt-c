# the code is mostly from https://raw.githubusercontent.com/EleutherAI/gpt-neo/master/data/create_tfrecords.py
import argparse
import os
...
parser.add_argument("--separator", nargs="+", type=int, default=[49407], # 49407 == tokenizer.encoder['<|endoftext|>']
